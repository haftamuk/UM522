...
var adapter = function (device) {
  ...
  this.receive_alarm = function (msg_parts) {
    try {
      ...
      const alarmCode = str.substr(54, 2) || '01';
      ...
      const alarmTypes = {
        ...
        '22': 'Door Open',
        '23': 'Door Close',
        '46': 'Temperature Alarm',
        '50': 'Vibration Alarm'
      };
      
      const alarmType = alarmTypes[alarmCode] || `Unknown Alarm: ${alarmCode}`;
