...
var adapter = function (device) {
  ...
  this.receive_alarm = function (msg_parts) {
    ...
    let dateHexa = str.substr(0, 12).match(/.{1,2}/g);
    let dateDecimal = dateHexa.map((val)=> parseInt(val, 16));
    let dateObj = new Date("20"+dateDecimal[0],dateDecimal[1],dateDecimal[2],dateDecimal[3],dateDecimal[4],dateDecimal[5]);
    ...
    console.log('alert');
    console.log("receive_alarm : ", data);
  ...
  this.get_ping_data = function (msg_parts) {
    ...
    console.log(" get_ping_data : ", data);
